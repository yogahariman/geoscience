# contoh seismic shmin prediction 2D (supervised)
...
# urutan atribut harus sama dengan FEATURE_COLS saat training well log shmin
atb = [
...
output_segy = [f"/Drive/D/Temp/20260218_{line}_SHMIN_PRED.sgy" for line in nmline]
